...
export function DiscoveryCard({ title, subtitle, user, distance, tag, image, tagClassName, href }: DiscoveryCardProps) {
  return (
    <article className="group w-[272px] shrink-0 overflow-hidden rounded-2xl border border-border/70 bg-background shadow-[0_10px_30px_rgba(15,23,42,0.08)] transition-all duration-200 hover:scale-[1.01]">
      <Link href={href} className="block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/70">
