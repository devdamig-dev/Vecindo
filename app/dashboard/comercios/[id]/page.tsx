    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-xl border border-dashed border-border bg-card p-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">El comercio que querés ver no existe o fue removido.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex max-w-3xl flex-col gap-6">
      ...
      <div className="relative -mt-10 mx-4 flex flex-col gap-4 rounded-xl border border-border bg-card p-5 md:mx-8">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          <Button asChild className="gap-2" onClick={() => trackWhatsAppClick(commerce.id)}>
          ...
          <Button asChild variant="outline" className="gap-2" onClick={() => trackCallClick(commerce.id)}>
