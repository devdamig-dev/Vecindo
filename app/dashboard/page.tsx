...
const mainModules: QuickAction[] = [
  ...
  { label: "Servicios", description: "Ofrecé o encontrá servicios", icon: Wrench, href: "/dashboard/services", theme: "services", chip: "Confiable" },
  { label: "Espacio comercial", description: "Negocios y emprendimientos", icon: Store, href: "/dashboard/espacio-comercial", theme: "commercial", chip: "Local" },
  { label: "Ayuda comunitaria", description: "Mascotas, seguridad, colectas y más", icon: Heart, href: "/dashboard/ayuda", theme: "help", chip: "Solidario" },
]
...
const roleNudges: Record<HomeRole, RoleNudge> = {
  resident: {
    ...
    insight: "Novedades, comercios, servicios y pedidos vecinales se actualizan durante el día.",
  ...
  service_provider: {
    ...
    insight: "4 vecinos buscaron electricistas y arreglos del hogar esta semana.",
  ...
  resident_business: {
    ...
    insight: "Productos locales y recomendaciones del barrio siguen generando interés cerca tuyo.",
    cta: "Ir a Mi negocio",
  ...
  external_business: {
    ...
    insight: "Cerca tuyo concentra comercios y emprendimientos que la zona descubre primero.",
    cta: "Ir a Mi negocio",
    href: "/dashboard/comercial",
    icon: Megaphone,
  },
...
const opportunities: Record<HomeRole, Opportunity[]> = {
  ...
  service_provider: [
    { title: "Consulta de la zona", subtitle: "Un vecino busca presupuesto para arreglos del hogar.", meta: "Hace 1 h", href: "/dashboard/services", icon: MessageCircleQuestion },
    { title: "Comercio renovando equipamiento", subtitle: "Posible alianza para mantenimiento recurrente.", meta: "Espacio comercial", href: "/dashboard/espacio-comercial", icon: Handshake },
  ],
  resident_business: [
    { title: "Producto con potencial", subtitle: "Tu catálogo puede aparecer entre destacados del barrio.", meta: "Mi negocio", href: "/dashboard/comercial", icon: PackageOpen },
  ...
  external_business: [
    { title: "Patrocinio sugerido", subtitle: "Cerca tuyo puede reforzar tu presencia durante los próximos días.", meta: "Crecimiento", href: "/dashboard/espacio-comercial", icon: Megaphone },
    { title: "Optimizar catálogo", subtitle: "Sumá productos de entrada para convertir más visitas.", meta: "Mi negocio", href: "/dashboard/comercial", icon: PackageOpen },
  ],
}
    ...
    <section className="rounded-3xl border border-primary/10 bg-card/90 p-3.5 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-primary">{nudge.eyebrow}</p>
          <p className="mt-0.5 text-sm font-semibold text-foreground">{nudge.title}</p>
          <p className="mt-1 text-xs leading-relaxed text-muted-foreground">{nudge.insight}</p>
        </div>
        <Link href={nudge.href} className="inline-flex w-fit shrink-0 items-center gap-1 rounded-full bg-foreground px-3 py-1.5 text-[11px] font-semibold text-background transition-transform hover:-translate-y-0.5">
          {nudge.cta}
