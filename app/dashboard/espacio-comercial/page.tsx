  ...
  return (
    <div className="flex max-w-full flex-col gap-6">
      <div className="space-y-1">
        <div className="inline-flex items-center gap-2 rounded-full bg-amber-100 px-3 py-1 text-xs font-medium text-amber-700"><Store className="h-3.5 w-3.5" />Espacio comercial</div>
      ...
      <Tabs defaultValue="comercios" className="w-full">
        ...
        <TabsContent value="comercios" className="mt-5 space-y-4">
          <div className="rounded-[24px] border border-sky-200 bg-sky-50 p-5">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="flex items-center gap-2 text-sky-700"><MapPin className="h-4 w-4" /><span className="font-medium">Comercios</span></div>
              ...
              <Button asChild className="bg-sky-600 text-white hover:bg-sky-700"><Link href="/dashboard/comercios">Explorar comercios</Link></Button>
            </div>
          </div>
        ...
        <TabsContent value="emprendimientos" className="mt-5 space-y-4">
          <div className="rounded-[24px] border border-amber-200 bg-amber-50 p-5">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="flex items-center gap-2 text-amber-700"><Sparkles className="h-4 w-4" /><span className="font-medium">Emprendimientos locales</span></div>
              ...
              <Button asChild className="bg-amber-600 text-white hover:bg-amber-700"><Link href="/dashboard/comercios?tipo=emprendimientos">Explorar emprendimientos</Link></Button>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {showMyBusiness ? (
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button asChild className="bg-amber-600 text-white hover:bg-amber-700"><Link href="/dashboard/services"><Search className="mr-2 h-4 w-4" />Ofrecer servicio</Link></Button>
            </div>
          )}
        </div>
      </div>
